...
export class PressKeysBeanViewModel {
    ...
    getPressKeys(): Array<Array<PressKeysBean>> {
        return [
            [
                new PressKeysBean(0, '32vp', '32vp', 'clean', { "id": 16777232, "type": 20000, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" }),
            ...
            [
                new PressKeysBean(0, '32vp', '32vp', 'div', { "id": 16777233, "type": 20000, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" }),
            ...
            [
                new PressKeysBean(0, '24vp', '24vp', 'min', { "id": 16777255, "type": 20000, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" }),
                new PressKeysBean(0, '32vp', '32vp', 'add', { "id": 16777235, "type": 20000, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" }),
                new PressKeysBean(0, '32vp', '32vp', 'equ', { "id": 16777234, "type": 20000, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" })
            ]
        ];
    }
}
